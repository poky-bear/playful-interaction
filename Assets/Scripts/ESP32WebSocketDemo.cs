...
public class ESP32WebSocketDemo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("ESP32WebSocketDemo initialized. Ready to receive pressure data.");
    ...
    // Button handler to test the WebSocket connection
    public void TestWebSocketConnection()
    {
        if (webSocketManager != null)
        {
            webSocketManager.TestWebSocketConnection();
        }
    }
}